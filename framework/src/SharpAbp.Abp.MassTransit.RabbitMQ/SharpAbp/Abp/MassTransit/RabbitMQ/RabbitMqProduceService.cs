...
{
    public class RabbitMqProduceService : IRabbitMqProduceService, ITransientDependency
    {
        protected IServiceScopeFactory ServiceScopeFactory { get; }
        public RabbitMqProduceService(IServiceScopeFactory serviceScopeFactory)
        {
