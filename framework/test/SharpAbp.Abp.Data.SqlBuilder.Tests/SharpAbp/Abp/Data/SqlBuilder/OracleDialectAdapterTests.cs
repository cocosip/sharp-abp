...
{
    /// <summary>
    /// Unit tests for OracleDialectAdapter
    /// Tests Oracle-specific database naming conventions and SQL syntax adaptations
    /// </summary>
    public class OracleDialectAdapterTests : AbpDataSqlBuilderTestBase
    {
        private readonly IDatabaseDialectAdapter _adapter;
        private readonly Mock<IDbConnection> _mockConnection;

        /// <summary>
        /// Initializes a new instance of the OracleDialectAdapterTests class
        /// </summary>
        public OracleDialectAdapterTests()
        {
            _adapter = ServiceProvider.GetKeyedService<IDatabaseDialectAdapter>(DatabaseProvider.Oracle);
            _mockConnection = new Mock<IDbConnection>();
        }

        /// <summary>
        /// Test that DatabaseProvider property returns Oracle
        /// </summary>
        [Fact]
        public void DatabaseProvider_ShouldReturnOracle()
        {
            // Act
        ...
        public void NormalizeTableName_WithSchemaAndPrefix_ShouldIncludeBothWithDoubleQuotes()
        {
            ...
            // Assert
            Assert.Equal("\"dbo\".\"AppUsers\"", result);
        }
        ...
        /// </summary>
        [Fact]
        public void NormalizeParameterName_WithValidParameterName_ShouldPrefixWithColon()
        {
            // Arrange
        ...
        /// <summary>
        /// Test NormalizeParameterName with parameter name that already has colon prefix
        /// </summary>
        [Fact]
        public void NormalizeParameterName_WithExistingColonPrefix_ShouldNotDuplicatePrefix()
        {
            // Arrange
            var parameterName = ":userId";
