...
{
    /// <summary>
    /// Unit tests for PostgreSqlDialectAdapter
    /// Tests PostgreSQL-specific database naming conventions and SQL syntax adaptations
    /// </summary>
    public class PostgreSqlDialectAdapterTests : AbpDataSqlBuilderTestBase
    {
        private readonly IDatabaseDialectAdapter _adapter;
        private readonly Mock<IDbConnection> _mockConnection;

        /// <summary>
        /// Initializes a new instance of the PostgreSqlDialectAdapterTests class
        /// </summary>
        public PostgreSqlDialectAdapterTests()
        {
            _adapter = ServiceProvider.GetKeyedService<IDatabaseDialectAdapter>(DatabaseProvider.PostgreSql);
            _mockConnection = new Mock<IDbConnection>();
        }

        /// <summary>
        /// Test that DatabaseProvider property returns PostgreSql
        /// </summary>
        [Fact]
        public void DatabaseProvider_ShouldReturnPostgreSql()
        {
            // Act
        ...
        /// <summary>
        /// Test NormalizeTableName with table name containing schema in dot notation
        /// </summary>
        [Fact]
        public void NormalizeTableName_WithDotNotationSchema_ShouldParseSchemaAndTable()
        {
            // Arrange
