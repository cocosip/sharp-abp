...
{
    /// <summary>
    /// Unit tests for GaussDBDialectAdapter
    /// Tests GaussDB-specific database naming conventions and SQL syntax adaptations
    /// </summary>
    public class GaussDBDialectAdapterTests : AbpDataSqlBuilderTestBase
    {
        private readonly IDatabaseDialectAdapter _adapter;
        private readonly Mock<IDbConnection> _mockConnection;

        /// <summary>
        /// Initializes a new instance of the GaussDBDialectAdapterTests class
        /// </summary>
        public GaussDBDialectAdapterTests()
        {
            _adapter = ServiceProvider.GetKeyedService<IDatabaseDialectAdapter>(DatabaseProvider.GaussDB);
            _mockConnection = new Mock<IDbConnection>();
        }

        /// <summary>
        /// Test that DatabaseProvider property returns GaussDB
        /// </summary>
        [Fact]
        public void DatabaseProvider_ShouldReturnGaussDB()
        {
            // Act
