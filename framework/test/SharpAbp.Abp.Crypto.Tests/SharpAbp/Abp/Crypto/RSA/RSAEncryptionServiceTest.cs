...

-----END PRIVATE KEY-----";

            // PKCS#1 格式的PEM私钥
            var pkcs1KeyPem = @"-----BEGIN RSA PRIVATE KEY-----

-----END RSA PRIVATE KEY-----";

            // 测试导入PKCS#8 PEM格式私钥
            var privateKey1 = _rsaEncryptionService.ImportPrivateKeyPkcs8Pem(pkcs8KeyPem);
            Assert.NotNull(privateKey1);

            // 测试导入PKCS#1 PEM格式私钥
            var privateKey2 = _rsaEncryptionService.ImportPrivateKeyPem(pkcs1KeyPem);
        ...
        public void Encrypt_Decrypt_1024_Test()
        {
            ...
            var pub1 = keyPair.ExportPublicKeyToPem();
            var priv1 = keyPair.ExportPrivateKeyToPem();
            var priv1_pkcs8 = keyPair.ExportPrivateKeyPkcs8ToPem();
            ...
            var encrypted11 = _rsaEncryptionService.EncryptFromPem(pub1, plainText, Encoding.UTF8);
            var decrypted11 = _rsaEncryptionService.DecryptFromPem(priv1, encrypted11, Encoding.UTF8);
            Assert.Equal(plainText, decrypted11);
            var decrypted12 = _rsaEncryptionService.DecryptFromPkcs8Pem(priv1_pkcs8, encrypted11, Encoding.UTF8);
        ...
        public void Sign_Verify_Test()
        {
            ...
            var signature1 = _rsaEncryptionService.SignFromPem(priv, data);

            var r1 = _rsaEncryptionService.VerifySignFromPem(pub, data, signature1);
            Assert.True(r1);

            var signature2 = _rsaEncryptionService.SignFromPkcs8Pem(priv_pkcs8, data);
            var r2 = _rsaEncryptionService.VerifySignFromPem(pub, data, signature2);
            Assert.True(r2);

            var signature3 = _rsaEncryptionService.SignFromPem(priv_pem, data);
            var r3 = _rsaEncryptionService.VerifySignFromPem(pub, data, signature3);
            Assert.True(r3);

            var signature4 = _rsaEncryptionService.SignFromPkcs8Pem(priv_pkcs8_pem, data);
            var r4 = _rsaEncryptionService.VerifySignFromPem(pub, data, signature4);
            Assert.True(r4);
        }
