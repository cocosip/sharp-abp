...
namespace SharpAbp.Abp.DbConnectionsManagement
{
    public class DatabaseConnectionInfoAppServiceTest : DbConnectionsManagementTestBase
    {
        ...
        {
            var id1 = await _databaseConnectionInfoAppService.CreateAsync(new CreateDatabaseConnectionInfoDto()
            {
                Name = "mysql",
            ...
            var databaseConnectionInfo1 = await _databaseConnectionInfoAppService.GetAsync(id1);
            ...
            await _databaseConnectionInfoAppService.UpdateAsync(id1, new UpdateDatabaseConnectionInfoDto()
            {
                Name = "postgresql",
            ...
            var databaseConnectionInfo2 = await _databaseConnectionInfoAppService.GetAsync(id1);
            ...
            await _databaseConnectionInfoAppService.DeleteAsync(id1);
