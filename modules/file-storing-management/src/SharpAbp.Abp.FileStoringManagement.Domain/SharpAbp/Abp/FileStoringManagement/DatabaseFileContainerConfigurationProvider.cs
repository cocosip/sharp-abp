...
namespace SharpAbp.Abp.FileStoringManagement
{
    public class DatabaseFileContainerConfigurationProvider : IFileContainerConfigurationProvider
    {
        ...
        public DatabaseFileContainerConfigurationProvider(IFileContainerConfigurationConverter fileContainerConfigurationConverter, IDistributedCache<FileContainerConfiguration> configurationCache, IFileStoringContainerRepository fileStoringContainerRepository)
        {
        ...
        protected virtual async Task<FileContainerConfiguration> GetConfigurationInternal(string name)
        {
            ...
            if (configuration == null)
            {
                ...
                if (container != null)
                {
                    ...
                    await ConfigurationCache.SetAsync(name, configuration, new DistributedCacheEntryOptions()
                    {
