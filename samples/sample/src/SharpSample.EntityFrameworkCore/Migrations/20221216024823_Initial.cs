...
namespace SharpSample.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AbpDatabaseConnectionInfos",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    DatabaseProvider = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    ConnectionString = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpDatabaseConnectionInfos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MapCode = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpMapTenants", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpDatabaseConnectionInfos_Name",
                table: "AbpDatabaseConnectionInfos",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpMapTenants_Code",
                table: "AbpMapTenants",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AbpMapTenants_MapCode",
                table: "AbpMapTenants",
                column: "MapCode",
                unique: true);
