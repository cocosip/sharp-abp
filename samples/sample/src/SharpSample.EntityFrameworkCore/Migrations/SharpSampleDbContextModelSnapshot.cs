...
{
    [DbContext(typeof(SharpSampleDbContext))]
    partial class SharpSampleDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SharpAbp.Abp.DbConnectionsManagement.DatabaseConnectionInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AbpDatabaseConnectionInfos", (string)null);
                });

            modelBuilder.Entity("SharpAbp.Abp.FileStoringManagement.FileStoringContainer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AbpFileStoringContainers", (string)null);
                });

            modelBuilder.Entity("SharpAbp.Abp.FileStoringManagement.FileStoringContainerItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AbpFileStoringContainerItems", (string)null);
                });

            modelBuilder.Entity("SharpAbp.Abp.MapTenancyManagement.MapTenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AbpMapTenants", (string)null);
                });

            modelBuilder.Entity("SharpAbp.MinId.MinIdInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AbpMinIdInfos", (string)null);
                });

            modelBuilder.Entity("SharpAbp.MinId.MinIdToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AbpMinIdTokens", (string)null);
                });
            ...
            modelBuilder.Entity("SharpAbp.Abp.FileStoringManagement.FileStoringContainerItem", b =>
                {
                    b.HasOne("SharpAbp.Abp.FileStoringManagement.FileStoringContainer", null)
                        .WithMany("Items")
