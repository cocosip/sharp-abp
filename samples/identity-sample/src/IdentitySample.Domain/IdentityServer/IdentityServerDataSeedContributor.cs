...
namespace IdentitySample.IdentityServer
{
    public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        {
            await CreateApiScopeAsync("IdentitySample");
        }
        ...
        private async Task CreateApiResourcesAsync()
        {
            ...
            await CreateApiResourceAsync("IdentitySample", commonApiUserClaims);
        }
        ...
        private async Task CreateClientsAsync()
        {
            ...
            var consoleAndAngularClientId = configurationSection["IdentitySample_App:ClientId"];
            if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
            {
                var webClientRootUrl = configurationSection["IdentitySample_App:RootUrl"]?.TrimEnd('/');
            ...
            {
                var swaggerRootUrl = configurationSection["IdentitySample_Swagger:RootUrl"].TrimEnd('/');
