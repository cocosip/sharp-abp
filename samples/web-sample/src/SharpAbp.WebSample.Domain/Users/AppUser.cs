...
namespace SharpAbp.WebSample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update WebSampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update WebSampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
