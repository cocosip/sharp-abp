...
namespace SharpAbp.WebSample.EntityFrameworkCore
{
    ...
    public class WebSampleEntityFrameworkCoreModule : AbpModule
    {
        ...
        {
            context.Services.AddAbpDbContext<WebSampleDbContext>(options =>
            {
            ...
            Configure<AbpDbContextOptions>(options =>
            {
                 ...
                 * See also WebSampleMigrationsDbContextFactory for EF Core tooling. */
                options.UseSqlite();
            });
        }
    }
