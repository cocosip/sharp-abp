...
public class AllApiSampleDbContext :
    AbpDbContext<AllApiSampleDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public AllApiSampleDbContext(DbContextOptions<AllApiSampleDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(AllApiSampleConsts.DbTablePrefix + "YourEntities", AllApiSampleConsts.DbSchema);
